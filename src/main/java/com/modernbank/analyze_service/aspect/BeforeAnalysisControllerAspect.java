package com.modernbank.analyze_service.aspect;

import com.modernbank.analyze_service.api.request.BaseRequest;
import com.modernbank.analyze_service.service.HeaderService;
...
public class BeforeAnalysisControllerAspect {

    private final HeaderService headerService;

    @Before(value = "execution(* com.modernbank.analyze_service.controller.AnalysisController.*(..))")
